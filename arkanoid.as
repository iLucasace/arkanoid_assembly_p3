...
FIRST_HEART_FIRST_HALF_COLUMN		EQU	29d
FIRST_HEART_SECOND_HALF_COLUMN		EQU	30d
SECOND_HEART_FIRST_HALF_COLUMN		EQU	26d
SECOND_HEART_SECOND_HALF_COLUMN		EQU	27d
THIRD_HEART_FIRST_HALF_COLUMN		EQU	23d
THIRD_HEART_SECOND_HALF_COLUMN		EQU	24d
...
Timer:	PUSH R1
	...
	Right_Down:	MOV R1, RIGHT_DOWN
			MOV M[BallDirection], R1
			JMP End

	Right_Up:	MOV R1, RIGHT_UP
			MOV M[BallDirection], R1
			JMP End

	Left_Down:	MOV R1, LEFT_DOWN
			MOV M[BallDirection], R1
			JMP End

	Left_Up:	MOV R1, LEFT_UP
			MOV M[BallDirection], R1
			JMP End
...
LoseLifes:	PUSH R1
		...
		LoseFirstLife:	MOV R1, TWO_LIFES
				MOV M[Lifes], R1
				...
				MOV R1, FIRST_ROW
				MOV R2, FIRST_HEART_SECOND_HALF_COLUMN
				...
				MOV R1, FIRST_ROW
				MOV R2, FIRST_HEART_FIRST_HALF_COLUMN
		...
		LoseSecondLife:	MOV R1, ONE_LIFE
				MOV M[Lifes], R1
				...
				MOV R1, FIRST_ROW
				MOV R2, SECOND_HEART_SECOND_HALF_COLUMN
				...
				MOV R1, FIRST_ROW
				MOV R2, SECOND_HEART_FIRST_HALF_COLUMN
		...
		LoseThirdLife:	MOV R1, ZERO_LIFES
				MOV M[Lifes], R1
				...
				MOV R1, FIRST_ROW
				MOV R2, THIRD_HEART_SECOND_HALF_COLUMN
				...
				MOV R1, FIRST_ROW
				MOV R2, THIRD_HEART_FIRST_HALF_COLUMN
...
Main:	ENI
	...
	MOV R1, INITIAL_SP
	MOV SP, R1		 	; Inicializa a stack.
	MOV R1, CURSOR_INIT	; Inicializa o cursor...
	MOV M[CURSOR], R1		; Com o valor CURSOR_INIT.
